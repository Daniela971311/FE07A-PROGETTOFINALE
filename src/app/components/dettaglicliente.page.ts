...
@Component({
  template: `
    <div class="container-fluid mt-5" id="sfondo">
      <div class="card " style="width: 100%;">
        <div class="card-body  ">
          ...
          <div class="row mt-4 text-center">
            <div class="col-3">
              <button class="btn btn-secondary" (click)="mostraFatture(cliente.id)">
              📄 Mostra fatture
              </button>
            </div>
            <div class="col-3">
          ...
          <div class="container text-center">
            <table class="table table-hover">
              <tbody>
                <tr>
                  <td colspan="2" class="text-light fw-bold ">NOME:</td>
                  <td>
                    {{ cliente.nomeContatto }} {{ cliente.cognomeContatto }}
                  </td>
                </tr>
                <tr>
                  <td colspan="2" class="text-light fw-bold">TELEFONO:</td>
                  <td>{{ cliente.telefonoContatto }}</td>
                </tr>
                <tr>
                  <td colspan="2" class="text-light fw-bold">E-MAIL:</td>
                  <td>{{ cliente.emailContatto }}</td>
                </tr>
                <tr>
                  <td colspan="2" class="text-light fw-bold">
                    SEDE OPERATIVA:
                  </td>
                  <td>
                ...
                <tr>
                  <td colspan="2" class="text-light fw-bold">SEDE LEGALE:</td>
                  <td>
    ...
    <ng-template #content let-modal class="b-dark">
  ...
  styles: [
    `
      ...
      .card-body{
        background-color: #00021be6;
    border-radius: 6px;
    border: 3px solid #0a039e;
      }
    `,
  ],
})
